...
export const CRMSystem: React.FC<CRMProps> = ({ data, trainedModels }) => {
  ...
  return (
    <div className="flex h-full gap-0 animate-in fade-in duration-500 overflow-hidden relative selection:bg-indigo-500/30 bg-[#020617]">
      {/* 1. Sidebar: Precision List (Fixed Width) */}
      <div className="w-[260px] flex flex-col bg-[#0B1120] border-r border-slate-800/60 shrink-0 z-20">
      ...
      {selectedProfile ? (
      <div className="flex-1 flex flex-col overflow-hidden min-w-0 bg-slate-950 relative">
        ...
        <div className="flex-1 flex flex-col p-4 gap-4 h-full overflow-hidden">
            ...
            <div className={`relative rounded-xl overflow-hidden border ${tierConfig.border} bg-slate-900/60 backdrop-blur-xl shrink-0 min-h-[110px] flex items-center shadow-lg`}>
                <div className="flex items-center gap-6 px-6 w-full">
                     {/* Avatar & Basic */}
                     <div className="flex items-center gap-4 shrink-0 border-r border-white/5 pr-6 py-2">
                     ...
                     {/* Right: Key Metrics */}
                     <div className="flex gap-4 shrink-0 border-l border-white/5 pl-6 py-2">
            ...
            <div className="grid grid-cols-12 gap-4 h-[260px] shrink-0">
                {/* AI Decision Logic Console */}
                <div className="col-span-12 lg:col-span-8 bg-[#0F172A]/80 border border-slate-800 rounded-xl overflow-hidden flex flex-col shadow-2xl relative group">
                    ...
                    <div className="flex-1 p-4 flex gap-6 relative z-10">
                        {/* 1. Trigger (Input) */}
                        <div className="w-[140px] shrink-0 flex flex-col gap-2 border-r border-white/5 pr-4">
                        ...
                        <div className="flex-1 flex flex-col">
                             ...
                             <div className="flex-1 bg-black/40 rounded border border-slate-800 p-2 font-mono text-[10px] text-slate-400 leading-relaxed overflow-y-auto custom-scrollbar whitespace-pre-wrap">
                ...
                <div className="col-span-12 lg:col-span-4 flex flex-col gap-2">
                     {/* Predicted Impact */}
                     <div className="flex-1 bg-slate-900/60 border border-slate-800 rounded-xl p-4 flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-3 gap-4">
                ...
                <div className="bg-slate-900/60 border border-slate-800 rounded-xl flex flex-col shadow-lg backdrop-blur-sm overflow-hidden min-h-0">
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-slate-500 gap-4 bg-slate-950">
      ...
      {showFullReport && (
          <div className="fixed inset-0 z-[3000] bg-black/90 flex items-center justify-center backdrop-blur-md animate-in fade-in">
              <div className="bg-[#0B1120] border border-slate-700 p-0 rounded-2xl w-[1000px] h-[700px] flex flex-col shadow-2xl animate-in zoom-in-95 overflow-hidden">
